...
static uint8_t  g_u8PageBuff[PAGE_SIZE] = {"12345676"};    /* Page buffer to upload/download through HID report */
static uint32_t g_u32BytesInPageBuf = 1;          /* The bytes of data in g_u8PageBuff */
